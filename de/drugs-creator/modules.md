...
<Tabs>
  <Tab title="Dispatch">
    <Steps>
      <Step title="Zum Modules-Ordner navigieren">
        Gehe zum Ordner `drugs_creator/_modules/dispatch`.
      </Step>
  ...
  <Tab title="Gangs">
    <Steps>
      <Step title="Zum Modules-Ordner navigieren">
        Gehe zum Ordner `drugs_creator/_modules/gangs`.
      </Step>
      <Step title="Vorhandenes Modul duplizieren">
        Kopiere ein vorhandenes Modul (z.B. `default`) und füge es im gleichen Ordner als Vorlage ein.
      </Step>
  ...
  <Tab title="Inventory">
    <Steps>
      <Step title="Zum Modules-Ordner navigieren">
        Gehe zum Ordner `drugs_creator/_modules/inventory`.
      </Step>
      <Step title="Vorhandenes Modul duplizieren">
  ...
  <Tab title="Logs">
    <Steps>
      <Step title="Zum Modules-Ordner navigieren">
        Gehe zum Ordner `drugs_creator/_modules/logs`.
      </Step>
      <Step title="Vorhandenes Modul duplizieren">
  ...
  <Tab title="Menü">
    <Steps>
      <Step title="Zum Modules-Ordner navigieren">
        Gehe zum Ordner `drugs_creator/_modules/menu`.
      </Step>
      <Step title="Vorhandenes Modul duplizieren">
        Kopiere ein vorhandenes Modul (z.B. `menu_default`) und füge es im gleichen Ordner als Vorlage ein.
      </Step>
      <Step title="Die Kopie umbenennen">
        Benenne die eingefügte Kopie passend zur Integration um, die du erstellen möchtest.
      </Step>
  ...
  <Tab title="Fortschrittsbalken">
    <Steps>
      <Step title="Zum Modules-Ordner navigieren">
        Gehe zum Ordner `drugs_creator/_modules/progressbar`.
      </Step>
      <Step title="Vorhandenes Modul duplizieren">
        Kopiere ein vorhandenes Modul (z.B. `jaksam`) und füge es im gleichen Ordner als Vorlage ein.
      </Step>
  ...
  <Tab title="Stash">
    <Steps>
      <Step title="Zum Modules-Ordner navigieren">
        Gehe zum Ordner `drugs_creator/_modules/stash`.
      </Step>
      <Step title="Vorhandenes Modul duplizieren">
        Kopiere ein vorhandenes Modul (z.B. `jaksam_inventory`) und füge es im gleichen Ordner als Vorlage ein.
      </Step>
      ...
      <Step title="Die benötigten Funktionen implementieren">
        Öffne die umbenannte Datei (client- und serverseitig) und passe sie an die Events des Drittanbieter-Scripts an, das du integrierst:
  ...
  <Tab title="Text UI">
    <Steps>
      <Step title="Zum Modules-Ordner navigieren">
        Gehe zum Ordner `drugs_creator/_modules/textui`.
      </Step>
      <Step title="Vorhandenes Modul duplizieren">
