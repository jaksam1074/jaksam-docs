---
title: "Modules"
description: "Replace default features like progress bar, dispatch, and logs with your own custom modules."
icon: "puzzle-piece"
---

Modules are an easy way for Robberies Creator to replace certain default features (progress bar, dispatch, logs).

To choose an existing module, open the `/robberiescreator` menu, go to settings, and choose it. That's it.
...
<Tabs>
  <Tab title="Dispatch">
    <Steps>
      <Step title="Navigate to the modules folder">
        Go to the `robberies_creator/_modules/dispatch` folder.
      </Step>
  ...
  <Tab title="Logs">
    <Steps>
      <Step title="Navigate to the modules folder">
        Go to the `robberies_creator/_modules/logs` folder.
      </Step>
      <Step title="Duplicate an existing module">
  ...
  <Tab title="Progress Bar">
    <Steps>
      <Step title="Navigate to the modules folder">
        Go to the `robberies_creator/_modules/progressbar` folder.
      </Step>
      <Step title="Duplicate an existing module">
        Copy an existing module (e.g. `jaksam`) and paste it in the same folder as a template.
      </Step>
  ...
  <Tab title="Text UI">
    <Steps>
      <Step title="Navigate to the modules folder">
        Go to the `robberies_creator/_modules/textui` folder.
      </Step>
      <Step title="Duplicate an existing module">
