...
<CardGroup cols={2}>
  <Card title="How to update" icon="download" href="/how-to-update">
    Learn how to update your scripts to the latest version.
  </Card>

  <Card title="Trouble shooting" icon="wrench" href="/trouble-shooting">
    Fix common issues like crashes and item errors.
  </Card>

  <Card title="Common FAQ" icon="circle-question" href="/common-faq">
    Answers to frequently asked questions.
  </Card>

  <Card title="Nexus terms" icon="file-contract" href="/nexus-terms">
    Terms of use for scripts distributed via Nexus.
  </Card>

  <Card title="Licenses" icon="id-card" href="/licenses">
