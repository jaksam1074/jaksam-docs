---
title: "Create door"
description: "Create a new door server side with full control over access rules and behavior."
icon: "square-plus"
---
...
| `displayIcon`                    | boolean   | Whether to display the interaction icon                        | No       |
...
| `canBeLockpicked`                | boolean   | If true, the door can be lockpicked                             | No       |
| `alertPoliceOnLockpick`          | boolean   | If true, police is alerted when the door is lockpicked           | No       |
