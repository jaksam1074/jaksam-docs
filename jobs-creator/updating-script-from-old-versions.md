...
<Warning>
  You'll have to follow **all steps** from your _current version_ up to the _newer one_.
</Warning>
...
<Tabs>
  ...
  <Tab title="3.14">
    Run this query in the database to convert old database tables and create the new one.
